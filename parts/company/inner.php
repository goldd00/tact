<div class="Profile">
    <div class="Profile__wrap">
        <div id="anchor_company" class="Title Title--small Anchor">
            <h2 class="Title__text">COMPANY PROFILE</h2>
        ...
        <div class="Profile__table">
            ...
            <div class="Profile__table__row">
                <div class="Profile__table__cell">
                    <p class="Profile__table__title">事業内容</p>
                </div>
                <div class="Profile__table__cell">
                    <p class="Profile__table__desc">企業支援事業、マーケティング事業、広告戦略事業、コンテンツ制作事業、デジタルエクスペリエンス事業、エンターテインメント事業</p>
                </div>
            </div>
            <div class="Profile__table__row">
                <div class="Profile__table__cell">
